...
{
    public class DataToPrimeTypeConfiguration : IEntityTypeConfiguration<DataToPrime>
    {
        public void Configure(EntityTypeBuilder<DataToPrime> builder)
        {
            builder.ToTable("DataToPrime");
